# character-export Specification

## Purpose

Let the user take a finished character out of the app as a shareable, printable
file — a PDF laid out like the official D&D 5e character sheet. (Pflichtenheft
1.4.1 "Charakter exportieren".) For a first-time player this produces the most
recognizable, table-ready artifact the app can offer, without needing the app to
view it. Export is read-only over the stored character data; it changes no
persistence and adds no game data.
