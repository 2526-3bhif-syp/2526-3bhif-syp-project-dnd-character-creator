...
('Strength',     'Bedeutet: Natürliche Athletik, körperliche Kraft. Wichtig für: Barbar, Kämpfer, Paladin.'),
('Dexterity',    'Bedeutet: Körperliche Beweglichkeit, Reflexe, Gleichgewicht, Haltung. Wichtig für: Mönch, Waldläufer, Schurke.'),
('Constitution', 'Bedeutet: Gesundheit, Ausdauer, Lebenskraft. Wichtig für: Alle.'),
('Intelligence', 'Bedeutet: Geistige Schärfe, Erinnerungsvermögen, analytisches Denken. Wichtig für: Magier.'),
('Wisdom',       'Bedeutet: Aufmerksamkeit, Intuition, Einsicht. Wichtig für: Kleriker, Druide.'),
('Charisma',     'Bedeutet: Selbstvertrauen, Eloquenz, Führungsstärke. Wichtig für: Barde, Zauberer, Hexenmeister.');
...
('Acrobatics',      'Dexterity',    'Deine Fähigkeit, in schwierigen Situationen auf den Beinen zu bleiben und akrobatische Kunststücke auszuführen.'),
('Animal Handling', 'Wisdom',       'Deine Fähigkeit, domestizierte Tiere zu beruhigen, Reittiere ruhig zu halten und die Absichten eines Tieres zu erahnen.'),
('Arcana',          'Intelligence', 'Deine Fähigkeit, Wissen über Zauber, magische Gegenstände, arkane Symbole und magische Traditionen abzurufen.'),
('Athletics',       'Strength',     'Deine Fähigkeit, zu klettern, zu springen, zu schwimmen und andere körperliche Leistungen zu vollbringen.'),
('Deception',       'Charisma',     'Deine Fähigkeit, die Wahrheit überzeugend zu verbergen, sei es durch Irreführung oder offenes Lügen.'),
('History',         'Intelligence', 'Deine Fähigkeit, Wissen über historische Ereignisse, legendäre Personen, alte Königreiche und Kriege abzurufen.'),
('Insight',         'Wisdom',       'Deine Fähigkeit, die wahren Absichten einer Kreatur zu erkennen, etwa wenn du eine Lüge aufdecken willst.'),
('Intimidation',    'Charisma',     'Deine Fähigkeit, andere durch offene Drohungen, feindseliges Verhalten und körperliche Gewalt zu beeinflussen.'),
('Investigation',   'Intelligence', 'Deine Fähigkeit, nach Hinweisen zu suchen und daraus logische Schlüsse zu ziehen.'),
('Medicine',        'Wisdom',       'Deine Fähigkeit, einen sterbenden Gefährten zu stabilisieren oder eine Krankheit zu diagnostizieren.'),
('Nature',          'Intelligence', 'Deine Fähigkeit, Wissen über Gelände, Pflanzen und Tiere, das Wetter und natürliche Kreisläufe abzurufen.'),
('Perception',      'Wisdom',       'Deine Fähigkeit, mit deinen Sinnen etwas zu erspähen, zu hören oder anderweitig wahrzunehmen.'),
('Performance',     'Charisma',     'Deine Fähigkeit, ein Publikum mit Musik, Tanz, Schauspiel oder Geschichtenerzählen zu begeistern.'),
('Persuasion',      'Charisma',     'Deine Fähigkeit, andere mit Takt, gutem Auftreten und Freundlichkeit zu beeinflussen.'),
('Religion',        'Intelligence', 'Deine Fähigkeit, Wissen über Gottheiten, Riten und Gebete sowie religiöse Hierarchien abzurufen.'),
('Sleight of Hand', 'Dexterity',    'Deine Fähigkeit, Taschenspielertricks und geschickte Handgriffe auszuführen.'),
('Stealth',         'Dexterity',    'Deine Fähigkeit, dich vor Feinden zu verbergen, an Wachen vorbeizuschleichen oder dich an jemanden heranzuschleichen.'),
('Survival',        'Wisdom',       'Deine Fähigkeit, Spuren zu folgen, Wild zu jagen und natürliche Gefahren zu meistern.');
...
('Hill Dwarf',       'Darkvision',           'An das Leben unter der Erde gewöhnt, hast du hervorragende Sicht bei Dunkelheit und Dämmerung. Du siehst bei Schwachlicht innerhalb von 60 Fuß wie bei hellem Licht und in Dunkelheit wie bei Schwachlicht.'),
('Hill Dwarf',       'Dwarven Resilience',   'Du hast Vorteil bei Rettungswürfen gegen Gift und Resistenz gegen Giftschaden.'),
('Hill Dwarf',       'Dwarven Combat Training','Du bist mit Streitaxt, Handaxt, leichtem Hammer und Kriegshammer geübt.'),
('Hill Dwarf',       'Tool Proficiency',     'Du erhältst Übung mit Handwerkszeug deiner Wahl: Schmiedewerkzeug, Brauerbedarf oder Maurerwerkzeug.'),
('Hill Dwarf',       'Stonecunning',         'Wann immer du eine Intelligenzprobe (Geschichte) zum Ursprung von Steinmetzarbeiten ablegst, giltst du als in Geschichte geübt und addierst den doppelten Übungsbonus zur Probe.'),
('Hill Dwarf',       'Dwarven Toughness',    'Dein Trefferpunktemaximum steigt um 1 und erhöht sich um weitere 1, sooft du eine Stufe aufsteigst.'),
('Mountain Dwarf',   'Darkvision',           'Du siehst bei Schwachlicht innerhalb von 60 Fuß wie bei hellem Licht und in Dunkelheit wie bei Schwachlicht.'),
('Mountain Dwarf',   'Dwarven Resilience',   'Du hast Vorteil bei Rettungswürfen gegen Gift und Resistenz gegen Giftschaden.'),
('Mountain Dwarf',   'Dwarven Armor Training','Du bist mit leichter und mittlerer Rüstung geübt.'),
('High Elf',         'Darkvision',           'Du siehst bei Schwachlicht innerhalb von 60 Fuß wie bei hellem Licht und in Dunkelheit wie bei Schwachlicht.'),
('High Elf',         'Keen Senses',          'Du bist in der Fertigkeit Wahrnehmung geübt.'),
('High Elf',         'Fey Ancestry',         'Du hast Vorteil bei Rettungswürfen gegen Bezauberung, und Magie kann dich nicht in Schlaf versetzen.'),
('High Elf',         'Trance',               'Elfen müssen nicht schlafen. Stattdessen meditieren sie tief und bleiben dabei 4 Stunden am Tag in einem halbbewussten Zustand.'),
('High Elf',         'Elf Weapon Training',  'Du bist mit Langschwert, Kurzschwert, Kurzbogen und Langbogen geübt.'),
('High Elf',         'Cantrip',              'Du kennst einen Zaubertrick deiner Wahl aus der Zauberliste der Magier. Intelligenz ist dafür dein Zauberattribut.'),
('Wood Elf',         'Darkvision',           'Du siehst bei Schwachlicht innerhalb von 60 Fuß wie bei hellem Licht und in Dunkelheit wie bei Schwachlicht.'),
('Wood Elf',         'Keen Senses',          'Du bist in der Fertigkeit Wahrnehmung geübt.'),
('Wood Elf',         'Fey Ancestry',         'Du hast Vorteil bei Rettungswürfen gegen Bezauberung, und Magie kann dich nicht in Schlaf versetzen.'),
('Wood Elf',         'Mask of the Wild',     'Du kannst versuchen, dich zu verstecken, selbst wenn du nur leicht durch Laub, starken Regen, fallenden Schnee, Nebel oder andere Naturphänomene verdeckt bist.'),
('Drow',             'Superior Darkvision',  'Deine Dunkelsicht hat eine Reichweite von 120 Fuß.'),
('Drow',             'Sunlight Sensitivity', 'Du hast Nachteil bei Angriffswürfen und bei Weisheitsproben (Wahrnehmung), die auf Sicht beruhen, wenn du, dein Ziel oder das, was du wahrzunehmen versuchst, sich im direkten Sonnenlicht befindet.'),
('Drow',             'Drow Magic',           'Du kennst den Zaubertrick Tanzende Lichter. Ab der 3. Stufe kannst du einmal pro Tag den Zauber Feenfeuer wirken. Ab der 5. Stufe kannst du zusätzlich einmal pro Tag den Zauber Dunkelheit wirken. Charisma ist dein Zauberattribut für diese Zauber.'),
('Lightfoot Halfling','Lucky',               'Wenn du beim d20 für einen Angriffswurf, eine Attributsprobe oder einen Rettungswurf eine 1 würfelst, kannst du den Würfel neu werfen und musst das neue Ergebnis verwenden.'),
('Lightfoot Halfling','Brave',               'Du hast Vorteil bei Rettungswürfen gegen Furcht.'),
('Lightfoot Halfling','Halfling Nimbleness', 'Du kannst dich durch den Raum jeder Kreatur bewegen, die eine Größenkategorie größer ist als du.'),
('Lightfoot Halfling','Naturally Stealthy',  'Du kannst versuchen, dich zu verstecken, selbst wenn du nur durch eine Kreatur verdeckt bist, die mindestens eine Größenkategorie größer ist als du.'),
('Stout Halfling',   'Lucky',               'Wenn du beim d20 für einen Angriffswurf, eine Attributsprobe oder einen Rettungswurf eine 1 würfelst, kannst du den Würfel neu werfen und musst das neue Ergebnis verwenden.'),
('Stout Halfling',   'Brave',               'Du hast Vorteil bei Rettungswürfen gegen Furcht.'),
('Stout Halfling',   'Stout Resilience',    'Du hast Vorteil bei Rettungswürfen gegen Gift und Resistenz gegen Giftschaden.'),
('Human',            'Extra Language',      'Du kannst eine zusätzliche Sprache deiner Wahl sprechen, lesen und schreiben.'),
('Dragonborn',       'Draconic Ancestry',   'Du hast eine drakonische Abstammung. Wähle eine Drachenart aus der Tabelle der drakonischen Abstammung. Deine Odemwaffe und deine Schadensresistenz werden durch die gewählte Drachenart bestimmt.'),
('Dragonborn',       'Breath Weapon',       'Du kannst deine Aktion nutzen, um zerstörerische Energie auszuatmen. Deine drakonische Abstammung bestimmt Größe, Form und Schadensart des Ausstoßes.'),
('Dragonborn',       'Damage Resistance',   'Du hast Resistenz gegen die Schadensart, die mit deiner drakonischen Abstammung verbunden ist.'),
('Forest Gnome',     'Darkvision',          'An das Leben unter der Erde gewöhnt, siehst du bei Schwachlicht innerhalb von 60 Fuß wie bei hellem Licht und in Dunkelheit wie bei Schwachlicht.'),
('Forest Gnome',     'Gnome Cunning',       'Du hast Vorteil bei allen Rettungswürfen auf Intelligenz, Weisheit und Charisma gegen Magie.'),
('Forest Gnome',     'Natural Illusionist', 'Du kennst den Zaubertrick Kleinere Illusion. Intelligenz ist dafür dein Zauberattribut.'),
('Forest Gnome',     'Speak with Small Beasts','Durch Laute und Gesten kannst du einfache Gedanken mit kleinen oder kleineren Bestien austauschen.'),
('Rock Gnome',       'Darkvision',          'Du siehst bei Schwachlicht innerhalb von 60 Fuß wie bei hellem Licht und in Dunkelheit wie bei Schwachlicht.'),
('Rock Gnome',       'Gnome Cunning',       'Du hast Vorteil bei allen Rettungswürfen auf Intelligenz, Weisheit und Charisma gegen Magie.'),
('Rock Gnome',       'Artificer''s Lore',   'Wann immer du eine Intelligenzprobe (Geschichte) zu magischen Gegenständen, alchemistischen Objekten oder technischen Geräten ablegst, kannst du den doppelten Übungsbonus addieren.'),
('Rock Gnome',       'Tinker',              'Du bist mit Handwerkszeug (Bastlerwerkzeug) geübt. Damit kannst du 1 Stunde und Materialien im Wert von 10 GM aufwenden, um ein winziges mechanisches Gerät zu bauen.'),
('Half-Elf',         'Darkvision',          'Dank deines Elfenblutes hast du hervorragende Sicht bei Dunkelheit und Dämmerung. Du siehst bei Schwachlicht innerhalb von 60 Fuß.'),
('Half-Elf',         'Fey Ancestry',        'Du hast Vorteil bei Rettungswürfen gegen Bezauberung, und Magie kann dich nicht in Schlaf versetzen.'),
('Half-Elf',         'Skill Versatility',   'Du erhältst Übung in zwei Fertigkeiten deiner Wahl.'),
('Half-Orc',         'Darkvision',          'Du siehst bei Schwachlicht innerhalb von 60 Fuß wie bei hellem Licht und in Dunkelheit wie bei Schwachlicht.'),
('Half-Orc',         'Menacing',            'Du erhältst Übung in der Fertigkeit Einschüchtern.'),
('Half-Orc',         'Relentless Endurance','Wenn du auf 0 Trefferpunkte reduziert wirst, aber nicht sofort stirbst, kannst du stattdessen auf 1 Trefferpunkt fallen. Du kannst dieses Merkmal erst nach einer langen Rast erneut nutzen.'),
('Half-Orc',         'Savage Attacks',      'Wenn du mit einem Nahkampfwaffenangriff einen kritischen Treffer erzielst, kannst du einen der Schadenswürfel der Waffe ein weiteres Mal werfen und ihn zum zusätzlichen Schaden des kritischen Treffers addieren.'),
('Tiefling',         'Darkvision',          'Du siehst bei Schwachlicht innerhalb von 60 Fuß wie bei hellem Licht und in Dunkelheit wie bei Schwachlicht.'),
('Tiefling',         'Hellish Resistance',  'Du hast Resistenz gegen Feuerschaden.'),
('Tiefling',         'Infernal Legacy',     'Du kennst den Zaubertrick Thaumaturgie. Ab der 3. Stufe kannst du den Zauber Höllischer Tadel einmal als Zauber des 2. Grades mit diesem Merkmal wirken. Ab der 5. Stufe kannst du zusätzlich einmal den Zauber Dunkelheit mit diesem Merkmal wirken.');
...
('Barbarian',1,'Rage','In der Schlacht kämpfst du mit urwüchsiger Wildheit. In deinem Zug kannst du als Bonusaktion in einen Kampfrausch verfallen. Während des Rausches hast du Vorteil bei Stärkeproben und -rettungswürfen, einen Bonus auf Nahkampfschaden und Resistenz gegen Wucht-, Stich- und Hiebschaden.'),
('Barbarian',1,'Unarmored Defense','Solange du keine Rüstung trägst, entspricht deine RK 10 + Geschicklichkeitsmodifikator + Konstitutionsmodifikator.'),
('Barbarian',2,'Reckless Attack','Du kannst jede Vorsicht zur Verteidigung fallen lassen, um mit wilder Verzweiflung anzugreifen. Wenn du in deinem Zug deinen ersten Angriff machst, kannst du rücksichtslos angreifen. Das gibt dir Vorteil bei Nahkampfwaffenangriffen mit Stärke, aber Angriffswürfe gegen dich haben bis zu deinem nächsten Zug Vorteil.'),
('Barbarian',2,'Danger Sense','Du entwickelst ein untrügliches Gespür dafür, wenn in deiner Nähe etwas nicht stimmt. Das gibt dir Vorteil bei Geschicklichkeitsrettungswürfen gegen Effekte, die du sehen kannst.'),
('Bard',1,'Spellcasting','Du hast gelernt, das Gefüge der Wirklichkeit im Einklang mit deinen Wünschen und deiner Musik zu entwirren und neu zu formen.'),
('Bard',1,'Bardic Inspiration','Du kannst andere durch mitreißende Worte oder Musik inspirieren. Eine Kreatur mit einem Würfel der Bardeninspiration kann ihn werfen und das Ergebnis zu einer Attributsprobe, einem Angriffswurf oder einem Rettungswurf addieren.'),
('Bard',2,'Jack of All Trades','Du kannst den halben Übungsbonus zu jeder Attributsprobe addieren, die nicht bereits deinen Übungsbonus enthält.'),
('Bard',2,'Song of Rest','Du kannst beruhigende Musik oder Vorträge nutzen, um deinen verwundeten Verbündeten während einer kurzen Rast bei der Genesung zu helfen.'),
('Cleric',1,'Spellcasting','Als Kanal göttlicher Macht kannst du Klerikerzauber wirken.'),
('Cleric',1,'Divine Domain','Wähle eine Domäne, die mit deiner Gottheit verbunden ist. Deine Wahl gewährt dir auf der 1. Stufe Domänenzauber und weitere Merkmale.'),
('Cleric',2,'Channel Divinity','Du erhältst die Fähigkeit, göttliche Energie direkt von deiner Gottheit zu kanalisieren und damit magische Effekte zu speisen.'),
('Cleric',2,'Turn Undead','Als Aktion präsentierst du dein heiliges Symbol und sprichst ein Gebet, das die Untoten verdammt.'),
('Druid',1,'Druidic','Du beherrschst Druidisch, die Geheimsprache der Druiden.'),
('Druid',1,'Spellcasting','Indem du auf die göttliche Essenz der Natur selbst zurückgreifst, kannst du Zauber wirken, um diese Essenz nach deinem Willen zu formen.'),
('Druid',2,'Wild Shape','Ab der 2. Stufe kannst du als Aktion auf magische Weise die Gestalt einer Bestie annehmen, die du zuvor gesehen hast.'),
('Fighter',1,'Fighting Style','Du machst einen bestimmten Kampfstil zu deiner Spezialität.'),
('Fighter',1,'Second Wind','Du verfügst über eine begrenzte Reserve an Ausdauer, die dich vor Schaden schützt. In deinem Zug kannst du als Bonusaktion Trefferpunkte in Höhe von 1W10 + deiner Kämpferstufe zurückgewinnen.'),
('Fighter',2,'Action Surge','Ab der 2. Stufe kannst du dich für einen Moment über deine normalen Grenzen hinaus antreiben. In deinem Zug kannst du eine zusätzliche Aktion ausführen.'),
('Monk',1,'Unarmored Defense','Solange du keine Rüstung trägst und keinen Schild führst, entspricht deine RK 10 + Geschicklichkeitsmodifikator + Weisheitsmodifikator.'),
('Monk',1,'Martial Arts','Deine Übung in den Kampfkünsten verleiht dir die Meisterschaft über Kampfstile, die unbewaffnete Schläge und Mönchswaffen nutzen.'),
('Monk',2,'Ki','Ab der 2. Stufe erlaubt dir dein Training, die mystische Energie des Ki zu nutzen.'),
('Monk',2,'Unarmored Movement','Ab der 2. Stufe erhöht sich deine Bewegungsrate um 10 Fuß, solange du keine Rüstung trägst und keinen Schild führst.'),
('Paladin',1,'Divine Sense','Die Gegenwart starken Bösen meldet sich deinen Sinnen wie ein übler Geruch, und mächtiges Gutes klingt dir wie himmlische Musik in den Ohren.'),
('Paladin',1,'Lay on Hands','Deine gesegnete Berührung kann Wunden heilen. Du verfügst über einen Vorrat an Heilkraft, der sich nach einer langen Rast wieder auffüllt.'),
('Paladin',2,'Fighting Style','Du machst einen bestimmten Kampfstil zu deiner Spezialität.'),
('Paladin',2,'Spellcasting','Ab der 2. Stufe hast du gelernt, durch Meditation und Gebet auf göttliche Magie zurückzugreifen, um Zauber zu wirken.'),
('Paladin',2,'Divine Smite','Ab der 2. Stufe kannst du, wenn du eine Kreatur mit einem Nahkampfwaffenangriff triffst, einen Zauberplatz aufwenden, um gleißenden Schaden zu verursachen.'),
('Ranger',1,'Favored Enemy','Du hast bedeutende Erfahrung darin, eine bestimmte Art von Gegnern zu studieren, aufzuspüren, zu jagen und sogar mit ihnen zu sprechen.'),
('Ranger',1,'Natural Explorer','Du bist mit einer bestimmten Art von natürlicher Umgebung besonders vertraut und darin geübt, in solchen Regionen zu reisen und zu überleben.'),
('Ranger',2,'Fighting Style','Du machst einen bestimmten Kampfstil zu deiner Spezialität.'),
('Ranger',2,'Spellcasting','Bis zur 2. Stufe hast du gelernt, die magische Essenz der Natur zu nutzen, um Zauber zu wirken.'),
('Rogue',1,'Expertise','Auf der 1. Stufe wählst du zwei deiner Fertigkeitsübungen oder eine Fertigkeitsübung und deine Übung mit Diebeswerkzeug. Dein Übungsbonus wird für jede Attributsprobe verdoppelt, die eine der gewählten Übungen nutzt.'),
('Rogue',1,'Sneak Attack','Ab der 1. Stufe weißt du, wie man heimtückisch zuschlägt und die Ablenkung eines Gegners ausnutzt. Einmal pro Zug kannst du einer Kreatur, die du mit einem Angriff triffst, zusätzlichen Schaden von 1W6 zufügen, sofern du Vorteil beim Angriffswurf hast.'),
('Rogue',1,'Thieves'' Cant','Während deiner Schurkenausbildung hast du die Diebessprache gelernt, eine geheime Mischung aus Dialekt, Jargon und Codes.'),
('Rogue',2,'Cunning Action','Ab der 2. Stufe erlauben dir dein schnelles Denken und deine Beweglichkeit, dich rasch zu bewegen und zu handeln. In jedem deiner Züge im Kampf kannst du eine Bonusaktion nutzen, um zu spurten, dich zurückzuziehen oder dich zu verstecken.'),
('Sorcerer',1,'Spellcasting','Ein Ereignis in deiner Vergangenheit oder im Leben eines Elternteils oder Vorfahren hat einen unauslöschlichen Abdruck bei dir hinterlassen und dich mit arkaner Magie erfüllt.'),
('Sorcerer',1,'Sorcerous Origin','Wähle einen Zaubererursprung, der die Quelle deiner angeborenen magischen Kraft beschreibt.'),
('Sorcerer',2,'Font of Magic','Ab der 2. Stufe greifst du auf einen tiefen Quell der Magie in dir zu. Dieser Quell wird durch Zauberpunkte dargestellt, mit denen du verschiedene magische Effekte erzeugen kannst.'),
('Warlock',1,'Otherworldly Patron','Auf der 1. Stufe hast du einen Pakt mit einem überirdischen Wesen deiner Wahl geschlossen.'),
('Warlock',1,'Pact Magic','Deine arkanen Studien und die dir von deinem Schutzpatron verliehene Magie haben dir den Umgang mit Zaubern ermöglicht.'),
('Warlock',2,'Eldritch Invocations','In deinem Studium okkulten Wissens hast du Schauerliche Anrufungen entdeckt, Bruchstücke verbotenen Wissens, die dir eine beständige magische Fähigkeit verleihen.'),
('Wizard',1,'Spellcasting','Als Schüler arkaner Magie besitzt du ein Zauberbuch mit Zaubern, die das erste Aufblitzen deiner wahren Macht zeigen.'),
('Wizard',1,'Arcane Recovery','Du hast gelernt, durch das Studium deines Zauberbuchs einen Teil deiner magischen Energie zurückzugewinnen. Einmal pro Tag kannst du nach einer kurzen Rast verbrauchte Zauberplätze wiederherstellen.'),
('Wizard',2,'Arcane Tradition','Wenn du die 2. Stufe erreichst, wählst du eine arkane Tradition, die deine Ausübung der Magie prägt.');
