...
Ebenso soll es möglich sein, einen erstellten Charakter zu speichern und in ein Format (z. B. PDF) zu exportieren.
Zusätzlich wird es eine Liste aller bereits erstellten Charaktere geben.
Diese können vom Nutzer jederzeit bearbeitet, angesehen oder gelöscht werden.
Am Ende soll der Spieler den Charakter in Form eines Charakter-Sheets erhalten mit allen Attributen, Fähigkeiten und Zaubern.

Beispiel eines Charakter-Sheets:

image::images/sheet1.jpg[Example of a character-sheet]
